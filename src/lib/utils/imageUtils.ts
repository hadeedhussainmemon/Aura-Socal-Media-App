...
export const getProfileImageUrl = (user: { imageUrl?: string; image?: string } | null | undefined): string => {
  return user?.imageUrl || user?.image || "/assets/icons/profile-placeholder.svg";
};
